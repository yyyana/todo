...
<div class="ContForForm">
    <form class="Register" action="/auth/login" method="post">
        <dl>
            <dt><label class="Auth_Label" for="input_login">Login:</label></dt>
            <dd><input class="Auth_form  <?php if(!empty($errors["login"])):?> errorsAuth<?php endif;?> "
            ...
            <dd><input class="Auth_form <?php if(!empty($errors["pass"])):?> errorsAuth<?php endif;?>"
            ...
            <dd><input class="Auth_btnForm" type="submit" value="Enter"/> </dd>
        </dl>
    </form>
</div>
